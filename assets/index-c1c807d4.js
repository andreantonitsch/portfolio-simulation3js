...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:ln,depthTest:!1,depthWrite:!1})}function Ma(){return new $t({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:hs(),fragmentShader:`
		...
		`,blending:ln,depthTest:!1,depthWrite:!1})}function Sa(){return new $t({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:hs(),fragmentShader:`
...
`)}function Mf(i,e){const t={},n=i.getProgramParameter(e,i.ACTIVE_ATTRIBUTES);for(let r=0;r<n;r++){const s=i.getActiveAttrib(e,r),o=s.name;let a=1;s.type===i.FLOAT_MAT2&&(a=2),s.type===i.FLOAT_MAT3&&(a=3),s.type===i.FLOAT_MAT4&&(a=4),t[o]={type:s.type,location:i.getAttribLocation(e,o),locationSize:a}}return t}function pi(i){return i!==""}function La(i,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function Pa(i,e){return i.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const Sf=/^[ \t]*#include +<([\w\d./]+)>/gm;function es(i){return i.replace(Sf,yf)}const Ef=new Map([["encodings_fragment","colorspace_fragment"],["encodings_pars_fragment","colorspace_pars_fragment"],["output_fragment","opaque_fragment"]]);function yf(i,e){let t=Pe[e];if(t===void 0){const n=Ef.get(e);if(n!==void 0)t=Pe[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("Can not resolve #include <"+e+">")}return es(t)}const Tf=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Da(i){return i.replace(Tf,bf)}function bf(i,e,t,n){let r="";for(let s=parseInt(e);s<parseInt(t);s++)r+=n.replace(/\[\s*i\s*\]/g,"[ "+s+" ]").replace(/UNROLLED_LOOP_INDEX/g,s);return r}function Ua(i){let e="precision "+i.precision+` float;
precision `+i.precision+" int;";return i.precision==="highp"?e+=`
#define HIGH_PRECISION`:i.precision==="mediump"?e+=`
#define MEDIUM_PRECISION`:i.precision==="lowp"&&(e+=`
#define LOW_PRECISION`),e}function Af(i){let e="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===Ya?e="SHADOWMAP_TYPE_PCF":i.shadowMapType===ko?e="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===jt&&(e="SHADOWMAP_TYPE_VSM"),e}function wf(i){let e="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case Qn:case ei:e="ENVMAP_TYPE_CUBE";break;case sr:e="ENVMAP_TYPE_CUBE_UV";break}return e}function Rf(i){let e="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case ei:e="ENVMAP_MODE_REFRACTION";break}return e}function Cf(i){let e="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case Za:e="ENVMAP_BLENDING_MULTIPLY";break;case cl:e="ENVMAP_BLENDING_MIX";break;case ul:e="ENVMAP_BLENDING_ADD";break}return e}function Lf(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:n,maxMip:t}}function Pf(i,e,t,n){const r=i.getContext(),s=t.defines;let o=t.vertexShader,a=t.fragmentShader;const l=Af(t),c=wf(t),u=Rf(t),f=Cf(t),d=Lf(t),m=t.isWebGL2?"":vf(t),g=xf(s),v=r.createProgram();let p,h,b=t.glslVersion?"#version "+t.glslVersion+`
...
`].filter(pi).join(`
`)),o=es(o),o=La(o,t),o=Pa(o,t),a=es(a),a=La(a,t),a=Pa(a,t),o=Da(o),a=Da(a),t.isWebGL2&&t.isRawShaderMaterial!==!0&&(b=`#version 300 es
...
`;var bp=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};function Ap(i){return i&&i.__esModule&&Object.prototype.hasOwnProperty.call(i,"default")?i.default:i}var Ao={exports:{}};(function(i,e){(function(t,n){i.exports=n()})(bp,function(){var t=function(){function n(m){return o.appendChild(m.dom),m}function r(m){for(var g=0;g<o.children.length;g++)o.children[g].style.display=g===m?"block":"none";s=m}var s=0,o=document.createElement("div");o.style.cssText="position:fixed;top:0;left:0;cursor:pointer;opacity:0.9;z-index:10000",o.addEventListener("click",function(m){m.preventDefault(),r(++s%o.children.length)},!1);var a=(performance||Date).now(),l=a,c=0,u=n(new t.Panel("FPS","#0ff","#002")),f=n(new t.Panel("MS","#0f0","#020"));if(self.performance&&self.performance.memory)var d=n(new t.Panel("MB","#f08","#201"));return r(0),{REVISION:16,dom:o,addPanel:n,showPanel:r,begin:function(){a=(performance||Date).now()},end:function(){c++;var m=(performance||Date).now();if(f.update(m-a,200),m>l+1e3&&(u.update(1e3*c/(m-l),100),l=m,c=0,d)){var g=performance.memory;d.update(g.usedJSHeapSize/1048576,g.jsHeapSizeLimit/1048576)}return m},update:function(){a=this.end()},domElement:o,setMode:r}};return t.Panel=function(n,r,s){var o=1/0,a=0,l=Math.round,c=l(window.devicePixelRatio||1),u=80*c,f=48*c,d=3*c,m=2*c,g=3*c,v=15*c,p=74*c,h=30*c,b=document.createElement("canvas");b.width=u,b.height=f,b.style.cssText="width:80px;height:48px";var x=b.getContext("2d");return x.font="bold "+9*c+"px Helvetica,Arial,sans-serif",x.textBaseline="top",x.fillStyle=s,x.fillRect(0,0,u,f),x.fillStyle=r,x.fillText(n,d,m),x.fillRect(g,v,p,h),x.fillStyle=s,x.globalAlpha=.9,x.fillRect(g,v,p,h),{dom:b,update:function(y,R){o=Math.min(o,y),a=Math.max(a,y),x.fillStyle=s,x.globalAlpha=1,x.fillRect(0,0,u,v),x.fillStyle=r,x.fillText(l(y)+" "+n+" ("+l(o)+"-"+l(a)+")",d,m),x.drawImage(b,g+c,v,p-c,h,g,v,p-c,h),x.fillRect(g+p-c,v,c,h),x.fillStyle=s,x.globalAlpha=.9,x.fillRect(g+p-c,v,c,l((1-y/R)*h))}}},t})})(Ao);var wp=Ao.exports;const Rp=Ap(wp),ir=new Rp;ir.showPanel(0);document.body.appendChild(ir.dom);const ns=new Ae;window.addEventListener("mousemove",i=>{ns.x=i.clientX/wt.width*2-1,ns.y=-(i.clientY/wt.height)*2+1});const wo=document.querySelector("canvas.webgl"),ds=new fp,wt={width:window.innerWidth,height:window.innerHeight};window.addEventListener("resize",()=>{wt.width=window.innerWidth,wt.height=window.innerHeight,Rn.aspect=wt.width/wt.height,Rn.updateProjectionMatrix(),Nt.setSize(wt.width,wt.height),Nt.setPixelRatio(Math.min(window.devicePixelRatio,2))});const Nt=new yo({canvas:wo,antialias:!0,alpha:!0});Nt.shadowMap.enabled=!0;Nt.setSize(wt.width,wt.height);Nt.setPixelRatio(Math.min(window.devicePixelRatio,2));const Jt=new op,Rn=new At(27,wt.width/wt.height,.1,100);Rn.position.set(4,1,-4);Jt.add(Rn);const Cp=new or(-1,1,1,-1,1/Math.pow(2,53),1),Lp=new or(-1,1,1,-1,1/Math.pow(2,53),1),Ro=new ai(2,2),gt={quantity:64*64,simulation_resolution:[64,64],maxLifetime:7},Co=new si(.5,.5,.5),Lo=new To({color:new Ge("rgba(191, 91, 91, 1)")}),fs=new mt(Co,Lo);fs.position.set(2.5,0,1);fs.castShadow=!0;const ps=new mt(Co,Lo);ps.position.set(-2,0,1);ps.castShadow=!0;Jt.add(fs);Jt.add(ps);const Pp=new ai(10,10,10),cr=new mt(Pp,new lp);cr.receiveShadow=!0;cr.position.y=-.25;cr.rotation.x=-Math.PI/2;Jt.add(cr);let Sn=new Ht(gt.simulation_resolution[0],gt.simulation_resolution[1],{magFilter:je,minFilter:je,type:Ft,depthBuffer:!1}),Xr=new Ht(gt.simulation_resolution[0],gt.simulation_resolution[1],{magFilter:je,minFilter:je,type:Ft,depthBuffer:!1}),rr=new Ht(gt.simulation_resolution[0],gt.simulation_resolution[1],{magFilter:je,minFilter:je,type:Ft,depthBuffer:!1});const an=new $t({uniforms:{uResolution:{value:new Ae(gt.simulation_resolution[0],gt.simulation_resolution[1])},uDeltaTime:{value:0},uTime:{value:0},positionMap:{value:Sn.texture},speedMap:{value:rr.texture},maxLifetime:{value:gt.maxLifetime},mousePosition:{value:new D}},vertexShader:gp,fragmentShader:vp}),$i=new $t({uniforms:{uResolution:{value:new Ae(gt.simulation_resolution[0],gt.simulation_resolution[1])},speed:{value:1},positionMap:{value:Sn.texture},uTime:{value:0},uDeltaTime:{value:0}},vertexShader:xp,fragmentShader:Mp}),Dp=new mt(Ro,an),Up=new mt(Ro,$i);let Xa=ds.getElapsedTime();const Ip=()=>{const i=ds.getElapsedTime(),e=i-Xa;Xa=i,an.uniforms.uDeltaTime.value=e,an.uniforms.uTime.value=i,an.uniforms.positionMap.value=Sn.texture,an.uniforms.speedMap.value=rr.texture,$i.uniforms.positionMap.value=Sn.texture,$i.uniforms.uTime.value=i,an.uniformsNeedUpdate=!0,$i.uniformsNeedUpdate=!0,Nt.setRenderTarget(Xr),Nt.render(Dp,Cp),Nt.setRenderTarget(rr),Nt.render(Up,Lp),Nt.setRenderTarget(null);const t=Sn;Sn=Xr,Xr=t},yi=gt.quantity*18,Ji=new Float32Array(yi*3),Po=new Uint32Array(yi),Qi=new Uint32Array(yi);let Ki=0;for(let i=0;i<yi;i+=0){const e=(Math.random()-.5)*2,t=(Math.random()-.5)*2,n=(Math.random()-.5)*2;for(let r=0;r<18;r++)Ji[i]=e,Ji[i+1]=t,Ji[i+2]=n,Qi[i]=Ki,Qi[i+1]=Ki,Qi[i+2]=Ki,i+=3;Ki+=1}for(let i=0;i<yi;i++)Po[i]=i;const ur=new dn;ur.setAttribute("position",new Et(Ji,3));ur.setAttribute("vertexID",new Et(Po,1));ur.setAttribute("instanceID",new Et(Qi,1));let mi={};const Np=(i,e=!1)=>t=>{t.vertexShader=t.vertexShader.replace("#include <common>",Sp),e?t.vertexShader=t.vertexShader.replace("#include <begin_vertex>",Tp):(t.vertexShader=t.vertexShader.replace("#include <begin_vertex>",Ep),t.vertexShader=t.vertexShader.replace("#include <defaultnormal_vertex>",yp)),t.vertexShader=resolveLygia(t.vertexShader),t.uniforms.positionMap={value:null},t.uniforms.speedMap={value:null},t.uniforms.uResolution={value:gt.simulation_resolution},t.uniforms.uTime={value:0},t.uniforms.maxLifetime={value:gt.maxLifetime},i.data=t.uniforms},Do=new To({color:new Ge("rgba(191, 91, 91, 1)")});Do.onBeforeCompile=Np(mi);const Uo=new mt(ur,Do);Jt.add(Uo);Uo.position.set(0,.5,0);const Ti=new mt(new ai(20,20,1,1),new cs);Ti.visible=!1;Ti.position.y=-.5;Ti.rotateX(-Math.PI/2);Jt.add(Ti);const qa=new pp;let qr=!0;const Fp=()=>{if(qr){qa.setFromCamera(ns,Rn);const i=qa.intersectObject(Ti);i.length>0&&(an.uniforms.mousePosition.value.copy(i[0].point),an.uniforms.mousePosition.value.y=-1)}qr=!qr},li=new hp("#ffffff",3);li.castShadow=!0;li.shadow.mapSize.set(1024,1024);li.shadow.camera.far=15;li.shadow.normalBias=.05;li.position.set(.25,2,-2.25);const Op=new dp("#ffffff",1);Jt.add(li);Jt.add(Op);const Io=new _p(Rn,wo);Io.enableDamping=!0;const No=()=>{const i=ds.getElapsedTime();Io.update(),ir.begin(),Fp(),Ip(),mi.data&&(mi.data.uTime.value=i,mi.data.positionMap.value=Sn.texture,mi.data.speedMap.value=rr.texture),Nt.render(Jt,Rn),ir.end(),window.requestAnimationFrame(No)};No();
